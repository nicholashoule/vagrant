Vagrant.configure("2") do |c|
  ...
  c.vm.define 'leap42' do |v|
    ...
    v.vm.network :private_network, ip: "10.255.233.156", :netmask => "255.255.255.0", :mac => "026008E42103"
  ...
  c.vm.define 'Fedora-Cloud-25' do |v|
    ...
    v.vm.box_check_update = 'true'
    v.vm.network :private_network, ip: "10.255.233.157", :netmask => "255.255.255.0", :mac => "026008E42104"
    v.vm.provider :virtualbox do |vb|
      vb.customize ['modifyvm', :id, '--memory', '1024', '--cpus', '1']
    end
    # Execute other stuff here
